...
public class TestTextToSpeech {
	...
	private static final String API_KEY = "iR_mH2sZ62KkZxOe_aExUaORWUuK6Lbec0XTLdhBw8Wq";
	private static final String URL = "https://api.kr-seo.text-to-speech.watson.cloud.ibm.com/instances/b68e917d-a7ab-4b45-9b8d-fd91b05b9d5c";
	...
	private void executeService() {
		...
		try {
			...
			File file = new File("e:/hello_world.mp3");
